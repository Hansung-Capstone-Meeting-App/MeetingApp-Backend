...
public class GeminiAiService {
    ...
    private String buildPrompt(
        ...
        sb.append("다음은 한국어 회의록이다. 회의 내용을 분석해서 요약, 키워드, 할 일을 추출하라.\n");
        ...
        sb.append("tasks는 회의에서 실제로 하기로 정했거나 마감 목표가 언급된 내용만 추출하라.\n");
    ...
    private GeminiAnalysisResult parseResponse(String text) {
        try {
            ...
            return new GeminiAnalysisResult(summary, keywords, tasks);
        } catch (Exception e) {
